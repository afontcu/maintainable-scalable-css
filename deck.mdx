...
"This is what CSS should look like!

We are using <strong>The Cascade™</strong>"
...
anyway, principles.
---
a long time ago, we decided this one was cool:
...
_(a.k.a. classes must have "meaning")_
...
Esto puede parecer super lógico, sobretodo si tienes la suerte de haber
"llegado" al CSS en los últimos tiempos. Pero no partíamos de aquí. No 
partíamos de crear CSS reusable: nuestro objetivo era crear "clases semánticas".
...
---
relies on classes as a primary hook for styling.
---
what if...
---
