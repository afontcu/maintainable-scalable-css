...
[Why can’t we use Functional CSS and regular CSS at the same time? - Robin Rendle](https://css-tricks.com/why-cant-we-use-functional-css-and-regular-css-at-the-same-time)
