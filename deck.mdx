...
pasando. Escribiamos en un lenguaje que no entendíamos.

El segundo problema con CSS es que esperábamos que fuera sencillo. Total, 
solo sirve para dar colores.
...
<Image src="images/wat-3.jpg" size="contain" />
...
```notes
Se trata de ver webs/apps de forma distinta: como sistemas dinamicos que 
cambian, en lugar de algo finito como una pintura o un cuadro, donde todo
tiene que ser perfecto y acabado.
...
un design system es algo *muy* grande. Es algo que incluye personas, una 
estrategia para aplicarlo, un buy-in por parte de la gente con dinero para
financiarlo, un compromiso por parte del equipo para mantenerlo... pero aqui
hablamos de hacia donde evolucionaba nuestro código.
```
...
```notes
Entre esto y que ya es fácil centrar verticalmente, nuestros backends están
encantados. Cuando les enseñe CSS Grid lo van a flipar.
```
...
<div class="c-card c-card--rounded">
  <h1 class="c-card__header u-padding">...</h1>
  <div class="c-card__body">
    <div class="o-media o-media--center u-padding-horizontal-small">
      <img class="o-media__img" src="" alt="" />
      <p class="o-media__body c-paragraph c-paragraph--thin">...</p>
    </div>
    <div class="c-card__footer c-card__footer--dark">
      <button class="c-btn c-btn--ghost">...</button>
      <button class="c-btn c-btn--primary">...</button>
    </div>
  </div>
...
<div class="u-padding u-border-radius u-background-white u-shadow-large">
  <h1 class="u-padding u-text-hairline">...</h1>
  <div class="u-padding-vertical-small">
    ...
    <div class="u-padding-small u-background-dark-gray
                u-flex u-flex-justify-between">
      <button class="c-btn c-btn--ghost">...</button>
      <button class="c-btn u-background-primary">...</button>
    </div>
  </div>
</div>
```
...
Comentar integración w/ Vue, React...
```
