...
Escribiamos en un lenguaje que no entendíamos.

El segundo problema con CSS es que esperábamos que fuera sencillo.
...
```notes
somos nosotros que escribimos CSS "mal"?
```
...
```notes
Esto ya lo podiamos haber hecho antes, con el CSS semántico.
```
