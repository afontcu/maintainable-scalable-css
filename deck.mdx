...
```notes
7 capas (físicamente: 7 carpetas) cada una con un propósito.
dar estructura y limitaciones a algo que no tiene (CSS).

ordenar CSS por especificidad. De menos a más.
ordenar CSS por alcance. De más a menos.
