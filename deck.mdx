...
```jsx
<div class="remove-pr">
  <h1 class="remove-pr-title">
  <div class="remove-pr-body">
    <img class="remove-pr-image">
    <p class="remove-pr-message">
  </div>
  <div class="remove-pr-buttons">
    <button class="remove">
    <button>
  </div>
</div>
...
<div class="c-card c-card--rounded">
  <h1 class="c-card__header u-padding u-text-hairline">
